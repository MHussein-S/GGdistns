#maximum goodness-of-fit estimates of Exponentiated G distribution family
#ex: EXPGmgof(data, distr="weibull", gof = "AD", start=list(a=0.5,scale=0.5,shape=0.5))
#EXPGmgof(data, distr="weibull", gof = "AD", start=c(a=0.5,scale=0.5,shape=0.5))
EXPGmgof <- function (data, distr, start,gof = "CvM",...)
{
