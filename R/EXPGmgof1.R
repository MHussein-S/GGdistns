#Maximum goodness-of-fit estimates of Exponentiated G distribution "using constroptim"
# start is must be a named vector ex: EXPGmgof1(data, distr="weibull", gof = "AD", start=c(a=0.5,scale=0.5,shape=0.5))
EXPGmgof1 <- function (data, distr, start,gof = "CvM",...)
{
